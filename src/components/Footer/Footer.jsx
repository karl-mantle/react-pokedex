...
const Footer = () => {
  ...
  return (
    <footer>
      <div className={`${footer.wrapper} ${footer.background} ${footer['clip-path']}`}>
        <a href="https://github.com/karl-mantle/react-pokedex" className={footer.github}>
          <svg height="24" viewBox="0 0 24 24" version="1.1" width="24" data-view-component="true" fill="currentColor">
          ...
          <span>karl-mantle/react-pokedex</span>
        </a>
      </div>
    </footer>
  )
